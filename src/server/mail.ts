...
function buildEstatusHtml(folio: string, estatus: EstatusFolio): string {
...
/**
 * Envía el correo de cambio de estatus al denunciante. Best-effort: no lanza.
 * @returns true si se envió, false si no (sin correo/credenciales o error).
 */
export async function sendEstatusEmail(
